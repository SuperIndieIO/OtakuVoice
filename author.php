...
<body>
    <header>
        <!--<a href='<?php echo esc_url( home_url( '/' ) ); ?>'>
            <img id='OV-LogoLarge' src='<?php echo get_template_directory_uri(); ?>/img/SuperIndieIOLogo.png' />
            <img id='OV-LogoSmall' src='<?php echo get_template_directory_uri(); ?>/img/SuperIndieIOSmallLogo.png' />
        </a>-->
    </header>
    <main>
